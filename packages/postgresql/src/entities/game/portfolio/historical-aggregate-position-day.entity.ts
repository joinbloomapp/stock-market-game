...
@Entity({ name: "HistoricalAggregatePositionDay" })
export class HistoricalAggregatePositionDay {
  ...
  static TABLE_NAME = "HistoricalAggregatePositionDay";
}

export { HistoricalAggregatePositionDay as default };
