...
@Entity({ name: "HistoricalAggregatePositionHour" })
export class HistoricalAggregatePositionHour {
  ...
  static TABLE_NAME = "HistoricalAggregatePositionHour";
}

export { HistoricalAggregatePositionHour as default };
